// En desarrollo, por defecto rutas relativas → Vite proxy (vite.config.js) hacia el gateway Profeco.
// En build de producción, define VITE_API_BASE_URL (URL absoluta del gateway).
const BASE =
